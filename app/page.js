...
export default function Portfolio() {
  ...
  return (
    <div style={{ background: colors.bg, color: colors.text, minHeight: '100vh', fontFamily: "'IBM Plex Sans', sans-serif" }}>
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-16 py-5 md:py-7" style={{ background: 'rgba(11,14,20,0.85)', backdropFilter: 'blur(10px)', borderBottom: '1px solid ' + colors.border }}>
        <a href="#top" className="text-lg md:text-xl font-semibold tracking-wide" style={{ fontFamily: "'Space Grotesk', sans-serif", color: colors.text }}>
        ...
        <div className="flex items-center gap-4 sm:gap-8 overflow-x-auto">
          {NAV.map((n) => (
            <a
              key={n.id}
              href={'#' + n.id}
              className="nav-link text-sm tracking-wide uppercase whitespace-nowrap"
      ...
      <section id="top" className="relative overflow-hidden px-6 md:px-16 pt-32 pb-16 md:pt-40 md:pb-24">
        ...
        <div className="max-w-6xl mx-auto hero-grid relative" style={{ zIndex: 1 }}>
          <div>
            ...
            <h1 className="gradient-text text-6xl md:text-8xl font-semibold mb-6" style={{ fontFamily: "'Space Grotesk', sans-serif", lineHeight: 1.0 }}>
              Virender Gupta
            </h1>
            <p className="text-xl md:text-2xl mb-8" style={{ color: colors.muted }}>
              Machine Learning Engineer &amp; Full-Stack Developer
            </p>
          ...
          <div className="justify-self-center float-slow">
            <div className="photo-frame" style={{ width: 250, height: 250 }}>
              <div className="halo" />
      ...
      <section id="about" className="px-6 md:px-16 py-20 md:py-28">
      ...
      <section id="skills" className="relative overflow-hidden px-6 md:px-16 py-20 md:py-28" style={{ background: colors.surface, borderTop: '1px solid ' + colors.border, borderBottom: '1px solid ' + colors.border }}>
      ...
      <section id="background" className="px-6 md:px-16 py-20 md:py-28" style={{ background: colors.surface, borderTop: '1px solid ' + colors.border, borderBottom: '1px solid ' + colors.border }}>
        ...
        <div className="max-w-6xl mx-auto mt-16 pt-12" style={{ borderTop: '1px solid ' + colors.border }}>
          <Reveal>
      ...
      <section id="contact" className="relative overflow-hidden px-6 md:px-16 py-24 md:py-32">
